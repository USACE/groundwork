...
export default App;`}
          ...
          <P>
            If you are deploying your application to a subdirectory on your web
            server, you will need to set a base path for your application. This
            is necessary to ensure that the internal-nav-helper can correctly
            determine the base URL for your application.
          </P>
          <P>
            To set the base path, you need to update the{" "}
...
export default defineConfig({
    ...
    plugins: [react()],
          ...
          <P>
            After you set the base path some of your paths that are not handled
            by the internal-nav-helper may not work as expected. You will need
          ...
          <P>
            ...
            variable is available in your application code and can be used to
            construct URLs with the base path.
          </P>
          <CodeExample
