...
function PopoutMenu({ title, children, direction = "right", className }) {
  ...
  return (
    ...
    >
      ...
      <PopoverPanel
        transition="true"
        className={`gw-z-10 gw-absolute gw-max-h-[50vh] gw-max-w-[50vw] gw-overflow-auto ${directionClasses[direction]} gw-mt-2 gw-w-56 gw-shrink gw-rounded-xl gw-bg-white gw-text-sm gw-leading-6 gw-text-gray-900 gw-shadow-lg gw-ring-1 gw-ring-gray-900/5`}
      >
        {children}
      </PopoverPanel>
    </Popover>
