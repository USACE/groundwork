    ...
    <div className="header_banner_container gw:bg-gov-banner-black gw:text-white">
      <div className={headerBannerInnerClass}>
        <div className="header_banner_flag gw:fill-gov-banner-gray gw:py-1.5 gw:h-12 gw:sm:h-8 gw:px-0 gw:text-sm gw:box-border gw:flex gw:items-center gw:justify-start">
          ...
          <div
            className="header_banner_accordion gw:text-gov-banner-gray gw:border-0 gw:cursor-pointer gw:text-sm gw:outline-hidden gw:text-left gw:transition-all gw:duration-300 gw:ease-out gw:my-0 gw:ms-1 gw:me-2.5 gw:sm:me-0 gw:inline-block focus:outline-5 focus:outline-focus-ring"
            tabIndex={0}
          >
            <u
              onClick={() => {
        ...
        {open ? (
          <div className="header_banner_panel gw:flex gw:flex-col gw:md:flex-row gw:my-0 gw:mx-auto gw:overflow-hidden gw:pt-6 gw:pb-4 gw:max-h-[328px] active">
