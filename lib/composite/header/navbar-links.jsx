...
function NavbarLinkItem({ link, ...props }) {
  ...
  const menuButtonClass = classNames(
    ...
    link.children
      ? "gw:after:content-['▼'] gw:after:text-[10px] gw:after:ml-2"
      : "",
  );
...
const NavbarLinks = ({ links = [] }) => {
  return (
    <div className="gw:hidden gw:md:flex gw:flex-row gw:content-center gw:justify-between gw:w-full gw:min-h-12 gw:pr-3">
